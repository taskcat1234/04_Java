...
public class TryCatchSerervice {
	...
	public void test2() {
		...
		try {
			...
			System.out.println("입력된 값이 정수가 아니거나 너무 큽니다.");
		}
	...
	public void test3() {
		...
		try {
			...
			// ArithmeticException과 inpArithmeticException의
			// 고통 부모 타입을 매개 변수로 선언
	...
	public void test4() {
		 ...
		 * */
		//catch(RuntimeException e) {
		//System.out.println("프로그램 실행 중 예외 발생"); // 부모타입은 맨밑으로 들어가야된다
		//} 
