...
public class ArrayService2 {
	...
	public void method1() {
		...
		// hashCode() : 주소를 이용해서 만든 해시 함수 결과 값
		...
		// -> 완전히 동일한 형태를 만들기 위해 같은 크기의 배열을 생성
		int[] copyArr2 = new int[arr2.length];
		
		// 2-1) for문을 이용해서 깊은 복사
		...
		// D : 복사할려는 배열에 값을 저장하기 시작할 인덱스 번호
	...
	public void method2() {
		...
		// 2차원 배열 : 가튼 자료형 1차원 배열 참조 변수의 묶음
		int[][] arr = new int[2][3];
		...
		System.out.println("arr[1] : " + arr[1]); // int[] 참조 주소
