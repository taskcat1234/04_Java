...
public class Student {
	...
	// private 접근 제한자 - 외부 직접 법근을 제한( 캡슐화 원칙 )
	...
	public Student() {
		...
		// (정수형 : 0, 실수형 : 0.00, 
		// 놀리형 : false, 문자형 : '\u0000'
		// 참조형 : null(참조하는 객체가 없다, 저장된 주소가 없다)
		
		/* 생성자를 이용해서 객체가 생성 될 떄 
		 * 필드 값을 원하는 값으로 초기화 할 수 있다! */
	...
	/* 오버로딩(OverLoadiing, 과적)
	 * - 하나의 클래스 내에 같은 이름의 메서드를 여러개 작성하는 기술
	 * - 같은 이름의 메서드는 원래 하나만 존재할수있지만
	 * 	 매개변수(순서,타입,개수)를 다르게하여
