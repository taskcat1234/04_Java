...
public class PolymorphismService {
	...
	public void test2() {
		...
		//Object section01.service.PolymorphismService.getInstance (int num)
		Object o1 = getInstance(1); // Child 객체 반환
		Object o2 = getInstance(2); // Parent 객체 반환
		Object o3 = getInstance(3); // Object 객체 반환
	
		// 매개변수의 다형성 + 반환형의 다형성
		// void section01.service.PolymorphismService.printObject (Object obj)
		printObject(o1);
		printObject(o2);
		printObject(o3);
	}
	 ...
	 * - 왜 사용?
	 * 	1) 다운 캐스팅의 번거로움을 없앰
	 *  2) 재정의된 메서드(조금 더 효율적 또는 알맞는 기능)을 수행
	 *  
	 * 
	...
	public void test3() {
		...
		Parent p2 = new Child("박",30,"포터"); // 부모 = 자식(업케스팅)
	...
	// 다운 캐스팅 시 주의 사항
	// - 강제 형변환이 적용되는 참조 변수가
	// 	 형변환 할려는 타입의 객체를 참조하고 있는지 확인 필요
	//	 -> instanceof 사용
	public void test5() {
		// 업 캐스팅
