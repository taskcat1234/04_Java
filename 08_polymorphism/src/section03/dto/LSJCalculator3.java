 ...
 * 	 오류 없이 가용 가능!!
 * 
 * - 단, default 메서드는 중복 되면 안된다!!
 * 
 */
public class LSJCalculator3 implements Calculator, Machine{
	...
	public int checkNum(int num) {
		// TODO Auto-generated method stub
		return Calculator.super.checkNum(num);
	}
	...
	@Override
	public void powwerOn() {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void powwerOff() {
		// TODO Auto-generated method stub
