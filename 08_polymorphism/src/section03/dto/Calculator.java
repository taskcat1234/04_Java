 ...
 *  
 *  - 인터페이스 사용법
 *  	1) 해당 인터페이스를 상속 받을 클래스에
 *  		 implements(구현하다) 키워드를 작성
 *  		 
 *  		 public class 클래스명 implements 인터페이스명{}
 *  	
 *  	2) 상속 받은 추상 메서드를 모두 오버라이딩
 *  	
 *  	3) 상속 받은 클래스를 객체로 만들어서 사용
 *  	
 *  	-> 사용 방법은 추상 클래스와 동일
 *  		1. 인터페이스는 객체 생성 불가
