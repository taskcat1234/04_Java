...
public class WrapperService {
	...
	public void printValue(Object obj) {
		...
		int num = wrap.intValue(); // Integer -> int Unboxin		
		System.out.println("값 출력 : " + num); // .toString() 호출
	}
	public void test1() {
		/* int -> Integer Boxing */
		int num1 = 100;
	...
	public void test3() {
		...
		int num1 = 500;
		//String s1 = num1; // 오류(왜? 자료형 불일치)
		String s1 = num1 + ""; // 권장 x (가끔은 괜찮음) ( 메모리 효율에 안좋음)
		
		// 방법2 ) Wrapper class의 valueOf() / toString() 이용
