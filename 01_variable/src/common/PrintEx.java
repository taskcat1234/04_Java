...
public class PrintEx {
	public static void main(String[] args) {
		 ...
		 * 
		 * - %f (float, 실수)        : 실수형 (float, doubl)
		 * 
		 * 
		 * - 양의 정수 : 정수 크기만큼 칸 확보 + 오른쪽 정렬
		 * ex) %4d, 대입 -> ㅁㅁㅁ3   (ㅁ은 빈칸을 표시)
		 * 
		 * - 음의 정수 : 정수 크기만큼 칸확보 + 왼쪽 정렬
		 * ex) %-4d, 대입 -> 3ㅁㅁㅁ (ㅁ은 빈칸을 표시)
		 * 
		 * - 소수점 : 소수점 아래 몇째 자리까지 표시할지 지정
		 * 						(지정된 자리 아래에서 반올림 처리)
		 * 
		 * ex) %.1f, 3.15 대입 -> 3.2
		 * 
		*/
		...
		double height = 80.5;      // 실수 기본형 8 바이트
		...
		System.out.println(name + "는 " + age + "세 " + gender + "아로 " 
											+ "키는 " + height + "cm이며, " + "자바 공부 여부 : " + javaStudy);
